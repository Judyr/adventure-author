...
{	
	...
	{	
		...
		{
			return ScriptHelper.GetConditionalFunctor("gc_dead",new object[]{sCreatureTag},ScriptOrigin.Original);
		}
		...
		{
			return ScriptHelper.GetConditionalFunctor("gc_is_open",new object[]{sObjectTag},ScriptOrigin.Original);
		}
		...
		public static NWN2ConditionalFunctor EnemyIsNearPlayer(float fRange)
		{
			...
			return ScriptHelper.GetConditionalFunctor("gc_is_enemy_near",new object[]{fRange,bLineOfSight},ScriptOrigin.Original);
		}
		...
		{
			return ScriptHelper.GetConditionalFunctor("gc_module_float",new object[]{sVariable,sCheck},ScriptOrigin.Override);
		}
		...
		{
			return ScriptHelper.GetConditionalFunctor("gc_module_int",new object[]{sVariable,sCheck},ScriptOrigin.Override);
		}
		...
		public static NWN2ConditionalFunctor ItemIsEquipped(string sItem)
		{
			...
			return ScriptHelper.GetConditionalFunctor("gc_equipped",new object[]{sItem,sTarget,bExactMatch},ScriptOrigin.Original);
		}	
		...
		{
			return ScriptHelper.GetConditionalFunctor("gc_module_string",new object[]{sVariable,sCheck},ScriptOrigin.Override);
		}
		...
		public static NWN2ConditionalFunctor PlayerHasGold(int nGold)
		{
			...
			return ScriptHelper.GetConditionalFunctor("gc_check_gold",new object[]{nGold,nMP},ScriptOrigin.Original);
		}
		...
		public static NWN2ConditionalFunctor PlayerHasHenchman(string sTarget)
		{
			...
			return ScriptHelper.GetConditionalFunctor("gc_henchman",new object[]{sTarget,sMaster},ScriptOrigin.Original);
		}
		...
		public static NWN2ConditionalFunctor PlayerHasItem(string sItem)
		{
			...
			return ScriptHelper.GetConditionalFunctor("gc_check_item",new object[]{sItem,bCheckParty},ScriptOrigin.Original);
		}
		...
		public static NWN2ConditionalFunctor PlayerHasNumberOfItems(string sItemTag, string sCheck)
		{
			...
			return ScriptHelper.GetConditionalFunctor("gc_item_count",new object[]{sItemTag,sCheck,bPCOnly},ScriptOrigin.Original);
		}						
		...
		{
			return ScriptHelper.GetConditionalFunctor("gc_align_chaotic",null,ScriptOrigin.Original);
		}	
		...
		{
			return ScriptHelper.GetConditionalFunctor("gc_align_evil",null,ScriptOrigin.Original);
		}	
		...
		{
			return ScriptHelper.GetConditionalFunctor("gc_is_female",null,ScriptOrigin.Original);
		}
		...
		{
			return ScriptHelper.GetConditionalFunctor("gc_align_good",null,ScriptOrigin.Original);
		}		
		...
		{
			return ScriptHelper.GetConditionalFunctor("gc_align_lawful",null,ScriptOrigin.Original);
		}			
		...
		{
			return ScriptHelper.GetConditionalFunctor("gc_is_male",null,ScriptOrigin.Original);
		}	
	}
}
