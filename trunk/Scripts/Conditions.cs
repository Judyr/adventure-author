...
{	
	...
	{	
		...
		{
			return ScriptHelper.GetConditionalFunctor("gc_dead",new object[]{sCreatureTag},ScriptHelper.NWN2ScriptsRepository);
		}
		...
		{
			return ScriptHelper.GetConditionalFunctor("gc_is_open",new object[]{sObjectTag},ScriptHelper.NWN2ScriptsRepository);
		}
		...
		public static NWN2ConditionalFunctor EnemyIsNearPlayer(float fRange)
		{
			...
			return ScriptHelper.GetConditionalFunctor("gc_is_enemy_near",new object[]{fRange,bLineOfSight},ScriptHelper.NWN2ScriptsRepository);
		}
		...
		{
			return ScriptHelper.GetConditionalFunctor("gc_module_float",new object[]{sVariable,sCheck},ScriptHelper.OverrideRepository);
		}
		...
		{
			return ScriptHelper.GetConditionalFunctor("gc_module_int",new object[]{sVariable,sCheck},ScriptHelper.OverrideRepository);
		}
		...
		public static NWN2ConditionalFunctor ItemIsEquipped(string sItem)
		{
			...
			return ScriptHelper.GetConditionalFunctor("gc_equipped",new object[]{sItem,sTarget,bExactMatch},ScriptHelper.NWN2ScriptsRepository);
		}	
		...
		{
			return ScriptHelper.GetConditionalFunctor("gc_module_string",new object[]{sVariable,sCheck},ScriptHelper.OverrideRepository);
		}
		...
		public static NWN2ConditionalFunctor PlayerHasGold(int nGold)
		{
			...
			return ScriptHelper.GetConditionalFunctor("gc_check_gold",new object[]{nGold,nMP},ScriptHelper.NWN2ScriptsRepository);
		}
		...
		public static NWN2ConditionalFunctor PlayerHasHenchman(string sTarget)
		{
			...
			return ScriptHelper.GetConditionalFunctor("gc_henchman",new object[]{sTarget,sMaster},ScriptHelper.NWN2ScriptsRepository);
		}
		...
		public static NWN2ConditionalFunctor PlayerHasItem(string sItem)
		{
			...
			return ScriptHelper.GetConditionalFunctor("gc_check_item",new object[]{sItem,bCheckParty},ScriptHelper.NWN2ScriptsRepository);
		}
		...
		public static NWN2ConditionalFunctor PlayerHasNumberOfItems(string sItemTag, string sCheck)
		{
			...
			return ScriptHelper.GetConditionalFunctor("gc_item_count",new object[]{sItemTag,sCheck,bPCOnly},ScriptHelper.NWN2ScriptsRepository);
		}						
		...
		{
			return ScriptHelper.GetConditionalFunctor("gc_align_chaotic",null,ScriptHelper.NWN2ScriptsRepository);
		}	
		...
		{
			return ScriptHelper.GetConditionalFunctor("gc_align_evil",null,ScriptHelper.NWN2ScriptsRepository);
		}	
		...
		{
			return ScriptHelper.GetConditionalFunctor("gc_is_female",null,ScriptHelper.NWN2ScriptsRepository);
		}
		...
		{
			return ScriptHelper.GetConditionalFunctor("gc_align_good",null,ScriptHelper.NWN2ScriptsRepository);
		}		
		...
		{
			return ScriptHelper.GetConditionalFunctor("gc_align_lawful",null,ScriptHelper.NWN2ScriptsRepository);
		}			
		...
		{
			return ScriptHelper.GetConditionalFunctor("gc_is_male",null,ScriptHelper.NWN2ScriptsRepository);
		}	
	}
}
