...
namespace Netron.Diagramming.Core.AdventureAuthor
{
    ...
    /// </summary>
    public class GraphController : IUndoSupport, IController
    {
        #region Events
        /// <summary>
        ...
        /// Default constructor
        /// </summary>
        public GraphController(IDiagramControl surface)
        {
...
//            this.AddTool(new MultiLineTool("MultiLine Tool"));
            ...
            #region Hotkeys
            GraphHotKeys keys = new GraphHotKeys(this);
...
//            (parentControl as Netron.Diagramming.Win.DiagramControl).toolTip.Show("Yihaaa", parentControl as Win.DiagramControl, ce.Location);
