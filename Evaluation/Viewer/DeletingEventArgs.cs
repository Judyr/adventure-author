...
{
	/// <summary>
	/// Arguments to accompany the event of a request for a section to be deleted.
	/// </summary>
	public class DeletingEventArgs : EventArgs
	{
		/// <summary>
		/// The control section to be deleted.
		/// </summary>
		private SectionControl sectionControl;			
		public SectionControl SectionControl {
			get { return sectionControl; }
		}
		...
		public DeletingEventArgs(SectionControl sectionControl)
		{
